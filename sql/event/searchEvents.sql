...
ORDER BY
  (
    (CASE WHEN "event_name" ILIKE ANY(${terms}) THEN 1 ELSE 0 END) +
    (CASE WHEN "society_name" ILIKE ANY(${terms}) THEN 1 ELSE 0 END) +
    (CASE WHEN "short_name" ILIKE ANY(${terms}) THEN 1 ELSE 0 END) +
